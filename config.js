const config = {
    ...
    PING_MESSAGE_PREFIX: ".\n\nAssistant (",
    PING_MESSAGE: "Write the next chat reply from Assistant in this fictional roleplay between Assistant and Human. Write a reply of only one to three paragraphs from Assistant and nothing more. Do not upload a file in the response. Always stay in character. At the end of the response append a single box detailing the character's internal thoughts or fantasies in a separate line within double ` backticks. Example: `I can't believe he did that!`. Limit the entire response to 1500 characters or less. Assistant:",
